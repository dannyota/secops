...
// `playbooks step insert` — offline graph authoring: splice a brand-new
...
// result still flows through `playbooks validate` and the guarded save —
