...
| **`gemini`** | Natural-language and assistant AI: `gemini generate` (NL → UDM, no run), `gemini search` (NL → UDM, then run), `gemini ask` (the SecOps assistant). | `query nl` / `query gemini` |
