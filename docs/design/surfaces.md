...
| job operational helpers (`soar job`) | 🔨 legacy operational | installed job and job-instance lists plus guarded `run` commands built; deeper job execution logs/status helpers still Wave 39 |
